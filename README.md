...
### Exercise mode
Exercises are pre-generated by an AWS Lambda that reads the source files from S3, calls **Amazon Bedrock** (Claude Haiku) to produce structured questions, and caches the results in **DynamoDB**. The frontend fetches them via **API Gateway**.
